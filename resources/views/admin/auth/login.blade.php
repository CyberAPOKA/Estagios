...
@section('content')
    ...
    <div class="container mt--8 pb-5">
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-7 pt-10">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <small>
                                ...
                                <br>
                                Username <strong>admin@argon.com</strong> Password: <strong>secret</strong><br>
                                Username <strong>recruiter@argon.com</strong> Password: <strong>secret</strong><br>
                                Username <strong>administrative@argon.com</strong> Password: <strong>secret</strong><br>
                                Username <strong>secretary@argon.com</strong> Password: <strong>secret</strong><br>
                                Username <strong>rh@argon.com</strong> Password: <strong>secret</strong><br>
                            </small>
                        </div>
