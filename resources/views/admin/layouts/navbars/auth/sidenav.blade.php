<aside
    class="sidenav bg-white navbar fixed-left navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    id="sidenav-main">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="navbar-examples" style="">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="https://argon-dashboard-laravel-bs4.creative-tim.com/profile">
                                User profile
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="https://argon-dashboard-laravel-bs4.creative-tim.com/user">
                                User Management
                            </a>
                        </li>
                    </ul>
